...
//    property string xALDateTimeformatMin: "mm:ss.zzz"
    ...
    property string xALMinFontFamily: "ubuntu"
    property color xALMinFontColor: Qt.rgba(0.5, 0.5, 0.5)
    property real xALMinFontSize: 10
    ...
    property string xAFontUOMFamily: "ubuntu"
    ...
    property real yALFormat: AxisSettings.EFORMAT_FLOAT
    ...
    property string yALMinFontFamily: "ubuntu"

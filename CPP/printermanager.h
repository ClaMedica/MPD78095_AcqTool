...
#ifndef INPRINTERMANAGER

extern const char *str_label_time[];
extern const unsigned char  print8x8Set[];
extern const unsigned char  print7x13Set[];
extern const unsigned char  print8x10SetSD[];
extern const unsigned char  SD[2][4][20];

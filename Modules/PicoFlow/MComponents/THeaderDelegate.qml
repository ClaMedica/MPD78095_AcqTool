...
Rectangle{
    ...
    Text {
        ...
        text: itemData.value
        font.bold: true
        font.pixelSize: layout.dimensionOf("F3")
    ...
    Image{
        ...
        anchors.margins: layout.value("Margin")
        height:layout.dimensionOf("THF")*0.9

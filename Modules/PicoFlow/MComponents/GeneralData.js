...
{
    //console.log("partiamo",item)
    var contentItem = findContentItem(item,0)
    //console.log(contentItem,"trovatoooooooooooooooooooo")
    restoreZorder(contentItem,0)
    //ora che sono tutti tornati a livello di default metto z di item a 1
    riseItem(item)
...
{//mentre cerca il padre setta anche la nuova z order
    item.z=newZ

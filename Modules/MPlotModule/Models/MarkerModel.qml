...
ListModel {
    ...
    property real limDefMax:100
    property real limDefMin:0
    property bool enabled:true
    property var strList:["descr","img","family","name","color","type","category","val","nas","valuesY","graph","code",
                            "whoAmI","channel","lock","defCode","key","visible","count","countVisible","limDefMax","limDefMin","enabled"]
    ...
    function setProperty(role,value)
    {
        ...
        case "limDefMax":limDefMax=value;break;
        case "limDefMin":limDefMin=value;break;
        case "enabled":enabled=value;break;

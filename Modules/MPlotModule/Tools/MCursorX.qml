...
Rectangle{
    ...
    function updateX(v)
    {
        ...
        if(modM.visible)
            visible=(valPer<-0.00005 || valPer>1.00005)?false:true
    ...
    //function showPopUp(){popTim.interval=200;popTim.start();}
    //function hidePopUp(){popTim.interval=800;popTim.start();}
